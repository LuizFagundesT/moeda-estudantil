...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        criarVantagemSeNaoExiste(cantina, "20% de desconto no almoço", "Desconto válido para uma refeição presencial na cantina parceira.", 120, "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=1200&auto=format&fit=crop", 10);
        criarVantagemSeNaoExiste(cantina, "Combo lanche especial", "Troque suas moedas por um combo com sanduíche, bebida e sobremesa.", 180, "https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=1200&auto=format&fit=crop", 5);
        criarVantagemSeNaoExiste(livraria, "Desconto em material acadêmico", "Cupom para compra presencial de cadernos, canetas e materiais de estudo.", 200, "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?q=80&w=1200&auto=format&fit=crop", 8);
        criarVantagemSeNaoExiste(livraria, "Vale livro técnico", "Benefício para abater parte do valor de um livro técnico selecionado.", 350, "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?q=80&w=1200&auto=format&fit=crop", 2);
        criarVantagemSeNaoExiste(livraria, "Vantagem esgotada para teste", "Item com quantidade zero para testar bloqueio de resgate.", 50, "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?q=80&w=1200&auto=format&fit=crop", 0);
    }

    private EmpresaParceira criarEmpresaSeNaoExiste(String email, String nome, String nomeFantasia, String cnpj, String cpf) {
    ...
    private void criarVantagemSeNaoExiste(EmpresaParceira empresa, String titulo, String descricao, Integer custo, String fotoUrl, Integer quantidade) {
